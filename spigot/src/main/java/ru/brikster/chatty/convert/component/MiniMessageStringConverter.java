...
public final class MiniMessageStringConverter implements ComponentStringConverter {

    private static final MiniMessageStringConverter INSTANCE = new MiniMessageStringConverter();
    ...
    public static ComponentStringConverter miniMessageStringConverter() {
        return INSTANCE;
    }
